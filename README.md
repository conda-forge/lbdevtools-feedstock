...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lbdevtools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10576&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lbdevtools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lbdevtools` can be installed with:

```
conda install lbdevtools
```

It is possible to list all of the versions of `lbdevtools` available on your platform with:
